...
sprite.src = 'https://res.cloudinary.com/face-studio/image/upload/v1636652142/Fit%20Game/sprite_bywb2j.png';
    ...
    function start() {
        if(!gameOver) {
            ...
            if(playing) {
                ...
                ctx.textAlign = "left";
                ctx.fillText('Recorde Global: '+record+'', 20, 30);
            ...
            ctx.fillStyle = "white";
            ctx.textAlign = "center";
            ctx.fillText("FIM DE JOGO",cW/2,cH/2 - 150);

            ctx.font = "15px Verdana";
            ctx.fillStyle = "white";
            ctx.textAlign = "center";
            ctx.fillText("você falhou ao proteger seu coração",cW/2,cH/2 - 118);
            ...
            ctx.fillStyle = "white";
            ctx.textAlign = "center";
            ctx.fillText("RECORDE: "+ record, cW/2,cH/2 + 185);

            ctx.drawImage(sprite, 500, 18, 70, 70, cW/2 - 35, cH/2 + 40, 70,70);

            canvas.removeAttribute('class');
            
            alert("Você ganhou 1 caixa para o iDrop");
        }
    }
